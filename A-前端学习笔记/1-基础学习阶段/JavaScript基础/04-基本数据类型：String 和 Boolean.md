...
var str3 = '地球炒蛋' + true;
var str4 = '地球炒蛋' + null;
var str5 = '地球炒蛋' + undefined;
var obj = { name: '地球炒蛋', age: 28 };
var str6 = '地球炒蛋' + obj;
console.log(str1);
console.log(str2);
console.log(str3);
...
字符串里面的值不可被改变。虽然看上去可以改变内容，但`其实是地址变了，内存中新开辟了一个内存空间。`
...
比如上面的代码，当重新给变量 str 赋值时，常量`hello`不会被修改，依然保存在内存中；str 会改为指向`PJ`。
...
console.log(html); // 打印结果也会换行,保留了换行符
```
...
console.log(`www.${getName()}.com`); // 打印结果：www.PJ.com
```
