...
> 上一篇文章 [this的指向问题及用法](https://blog.csdn.net/weixin_43745075/article/details/115575414) 中，提到了 call 和 apply。
>
> 它们最主要的作用，是改变 this 的指向。在平时的开发中，除了在写一些基础类，或者公用库方法的时候会用到它们，其他时候 call 和 apply 的应用场景并不多。
>
...
- call 和 apply 的主要作用，是改变对象的执行上下文，并且是`立即执行的。它们在参数上的写法略有区别`。
