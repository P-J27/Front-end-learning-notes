...
![url的组成](https://gitee.com/p_pj/pig/raw/master/img/1638b3579d9eeb32)
...
![img](https://gitee.com/p_pj/pig/raw/master/img/1638b3579dde630e)
...
JSONP优点是`简单兼容性好`，可用于解决主流浏览器的跨域数据访问的问题。**缺点是`仅支持get`方法具有局限性,`不安全可能会遭受XSS攻击`。**
...
- 将 响应 转发给客户端。
  ...
  ![image-20210407113807065](https://gitee.com/p_pj/pig/raw/master/img/image-20210407113807065.png)
