![img](https://gitee.com/p_pj/picgo/raw/master/img/20210522231943.jpeg)
...
TCP协议全称是传输控制协议是一种`面向连接的、可靠的、基于字节流的传输层通信协议`，由 IETF 的RFC 793定义。TCP 是面向连接的、可靠的流协议。流就是指不间断的数据结构，你可以把它想象成排水管中的水流。
